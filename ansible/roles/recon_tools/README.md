...
- **Reinstall source impacket into NetExec venv via pip (fallback for pipx inject)** (ansible.builtin.command) - Conditional
- **Re-verify regsecrets after pip fallback** (ansible.builtin.command) - Conditional
