...
specialized worker agents via NATS JetStream (broker) with Redis as the durable
state store, using a compiled Rust binary with embedded Python for LLM agent
steps.
