...
fn detection_query_tool_definitions() -> Vec<ToolDefinition> {
    vec![
        ...
        ToolDefinition {
            ...
            description: "Run multiple detection queries in parallel for efficiency.".into(),
            input_schema: json!({
                "type": "object",
                "properties": {
                    "query_names": {
                        "type": "array",
                        "items": { "type": "string" },
                        "description": "List of detection template names to run"
                    },
                    "target_host": {
                        "type": "string",
        ...
        ToolDefinition {
            ...
            description: "List all available detection query templates with descriptions.".into(),
            input_schema: json!({
                "type": "object",
                "properties": {}
            }),
