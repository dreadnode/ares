...
class TestRedBlueCorrelator:
    ...
    def test_correlate_multiple_activities(self, temp_reports_dir: Path) -> None:
        ...
        red_activities = [
            RedTeamActivity(
                ...
                action=f"Action {i}",
                target_ip=f"192.168.58.{100 + i}",  # Different IPs
                target_host=None,
                credential_used=None,
                success=True,
            )
        ...
        blue_detections = [
            BlueTeamDetection(
                ...
                technique_id=f"T100{i}",
                severity="high",
                target_ip=f"192.168.58.{100 + i}",  # Matching IPs
                target_host=None,
    ...
    def test_correlate_identifies_false_positives(
        ...
        unrelated_detection = BlueTeamDetection(
            ...
            severity="low",
            target_ip="192.168.58.1",  # Different target
            target_host=None,
    ...
    def test_technique_coverage_calculation(self, temp_reports_dir: Path) -> None:
        ...
        red_activities = [
            RedTeamActivity(
                ...
                technique_name=f"Technique {i}",
                action=f"Action {i}",
                target_ip=f"192.168.58.{100 + i}",  # Different targets
                target_host=None,
                credential_used=None,
                success=True,
            )
        ...
        blue_detections = [
            BlueTeamDetection(
                ...
                severity="high",
                target_ip=f"192.168.58.{100 + i}",  # Matching targets
                target_host=None,
                investigation_id=f"inv-{i}",
                status="completed",
                evidence_count=1,
