...
SQL>
    ...
    def test_mssql_enum_impersonation_formats_command_correctly(self):
        ...
        assert "test.local/testuser:TestPass123@192.168.56.25" in command_str
