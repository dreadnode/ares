...
class RedTeamDispatcher:
    ...
    async def _get_pending_count_by_role(self, role: str) -> int:
    ...
    async def _get_llm_task_count(self) -> int:
    ...
    def _get_operation_phase(self) -> str:
        """
    ...
    def _detect_phase_internal(self) -> str:
    ...
    def _get_phase_priority_adjustment(self, task_type: str, target_role: str) -> int:
        """
